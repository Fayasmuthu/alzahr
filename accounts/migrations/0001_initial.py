    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('usertype', models.CharField(choices=[('management', 'Management'), ('student', 'Student'), ('teacher', 'Teacher'), ('worker', 'Worker'), ('accountant', 'Accountant')], default='student', max_length=20)),
